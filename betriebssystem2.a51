...
prozessAuswahl:
	...
	;R6 = Prozess A läuft; R7 = Prozess B läuft	
		MOV A,#0
		CJNE A, tabAdresseCon, conLaeuft 				;Korrektur
		CJNE A, tabAdresseCon+1, conLaeuft				;Korrektur
			MOV R5,#0
		...
		ALaeuft:
			MOV R6,#1
			CJNE A, tabAdresseB, BLaeuft			;Korrektur
			CJNE A, tabAdresseB+1, BLaeuft			;Korrektur
					MOV R7,#0
...
prozessAktivierung:	
	...
	CJNE R2,#0, aktiviereAoderB
		;aktiviere Con
		MOV tabAktivCon,#1
		MOV A, #0							;Korrektur damit Grenzen nicht überschritten werden
		CJNE A, tabPrioCon, decPrioCon1
		JMP checkPrioA1
decPrioCon1:
		DEC tabPrioCon
checkPrioA1:
		MOV A, #2
		CJNE A, tabPrioA, incPrioA1
		JMP checkPrioB1
incPrioA1:
		INC tabPrioA
checkPrioB1:		
		CJNE A, tabPrioB, incPrioB1
		JMP rewriteGoto1
incPrioB1:
		INC tabPrioB
rewriteGoto1:
	...
	CJNE R2,#1, aktiviereB
		...
		MOV tabAktivA,#1
		MOV A, #0							;Korrektur damit Grenzen nicht überschritten werden
		CJNE A, tabPrioCon, decPrioCon2
		JMP checkPrioA2
decPrioCon2:
		DEC tabPrioCon
checkPrioA2:
		MOV A, #2
		CJNE A, tabPrioA, incPrioA2
		JMP checkPrioB2
incPrioA2:
		INC tabPrioA
checkPrioB2:		
		CJNE A, tabPrioB, incPrioB2
		JMP rewriteGoto2
incPrioB2:
		INC tabPrioB
rewriteGoto2:
	...
	CJNE R2,#2, aktiviereCon
		...
		MOV tabAktivB,#1
		MOV A, #0							;Korrektur damit Grenzen nicht überschritten werden
		CJNE A, tabPrioCon, decPrioCon3
		JMP checkPrioA3
decPrioCon3:
		DEC tabPrioCon
checkPrioA3:
		MOV A, #2
		CJNE A, tabPrioA, incPrioA3
		JMP checkPrioB3
incPrioA3:
		INC tabPrioA
checkPrioB3:		
		CJNE A, tabPrioB, incPrioB3
		JMP rewriteGoto3
incPrioB3:
		INC tabPrioB
rewriteGoto3:
	...
	aktiviereCon:;einfach per default, wenn was schief geht 
		...
		MOV tabAktivCon,#1
		MOV A, #0							;Korrektur damit Grenzen nicht überschritten werden
		CJNE A, tabPrioCon, decPrioCon4
		JMP checkPrioA4
decPrioCon4:
		DEC tabPrioCon
checkPrioA4:
		MOV A, #2
		CJNE A, tabPrioA, incPrioA4
		JMP checkPrioB4
incPrioA4:
		INC tabPrioA
checkPrioB4:		
		CJNE A, tabPrioB, incPrioB4
		JMP rewriteGoto4
incPrioB4:
		INC tabPrioB
rewriteGoto4:
